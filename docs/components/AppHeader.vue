    ...
    <GoHeaderBar breakpoint="tablet">
      ...
      <div class="nav-actions" slot="actions">
        <GoButton v-bind="repoLinkProps" variant="text" icon round flat compact :aria-label="siteConfig.repoLink.label">
          <GoIcon decorative size="1.5rem" icon-set="bxl" name="github"></GoIcon>
        </GoButton>
      ...
      <GoNavBar slot="nav-bar" :items="navItems"></GoNavBar>
    </GoHeaderBar>
  </header>
</template>

<script lang="ts" setup>
import { GoNavDrawer, GoHeaderBar, GoButton, GoIcon, GoGovAuLogo, GoDarkMode, GoNavBar } from '@go-ui/vue';
