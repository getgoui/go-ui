...
<div className="text-size-1">Progress bar indicates the progress status for a tasks that might take a long time, this can be determinate or indeterminate.</div>
